package com.tysci.ballq.views.widgets.convenientbanner;
...
import com.tysci.ballq.views.widgets.convenientbanner.adapter.CBPageAdapter;
import com.tysci.ballq.views.widgets.convenientbanner.holder.CBViewHolderCreator;
import com.tysci.ballq.views.widgets.convenientbanner.listener.CBPageChangeListener;
import com.tysci.ballq.views.widgets.convenientbanner.listener.OnItemClickListener;
import com.tysci.ballq.views.widgets.convenientbanner.view.CBLoopViewPager;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    private void init(Context context) {
        View hView = LayoutInflater.from(context).inflate(
                R.layout.layout_loop_viewpager, this, true);

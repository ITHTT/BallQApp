...
package com.tysci.ballq.views.widgets.recyclerviewstickyheader;
...
public class StickyHeaderDecoration extends RecyclerView.ItemDecoration {
    ...
    private Map<String, RecyclerView.ViewHolder> mHeaderCache;
    ...
    private boolean hasHeader(int position) {
        ...
        return !TextUtils.isEmpty(mAdapter.getHeaderId(position))&&!mAdapter.getHeaderId(position).equals(mAdapter.getHeaderId(previous));
    }

    private RecyclerView.ViewHolder getHeader(RecyclerView parent, int position) {
        final String key = mAdapter.getHeaderId(position);
            ...
            if(!TextUtils.isEmpty(currentId)){
                for (int i = 1; i < count; i++) {
                    ...
                    if (adapterPosHere != RecyclerView.NO_POSITION) {
                        ...
                        if (!TextUtils.isEmpty(nextId)&&!nextId.equals(currentId)) {

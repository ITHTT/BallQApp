 ...
 */
public class UserAccountGoldRecordFragment extends AppSwipeRefreshLoadMoreRecyclerViewFragment{
    ...
    protected void onLoadMoreData() {
        requestUserAccountGoldRecordInfos(currentPages,true);
    }

    @Override
    protected void onRefreshData() {
        requestUserAccountGoldRecordInfos(1,false);
    ...
    private void requestUserAccountGoldRecordInfos(final int pages, final boolean isLoadMore){
        String url= HttpUrls.HOST_URL_V5 + "user/transaction/gold/?p=" + pages;
                    ...
                    if(adapter!=null) {
                        ...
                        showErrorInfo(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                showLoading();
                                requestUserAccountGoldRecordInfos(pages,isLoadMore);
                            }
                        });
                    }
                }else{
